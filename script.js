...
var octopus = {
    ...
    draw : function() {
        ctx.drawImage(this.imageOctopus, this.x, this.y, 70, 70);
        ctx.drawImage(this.imageOctopus, this.x-50, this.y-50, 70, 70);
        ctx.drawImage(this.imageOctopus, this.x-100, this.y-100, 70, 70);
    }
...
var merman = {
    ...
    draw : function() {
        ctx.drawImage(this.imageMerman, this.x, this.y, 220, 150);
    }
};
